...
import * as fromEndpoint from '@core/reducers/endpoint.reducer.ts';
 ...
 * Endpoint Reducers
 */
export const getEndpointState = createFeatureSelector<State, fromEndpoint.State>(
  'endpoint'
);

export const getEndpoint = createSelector(
  getEndpointState,
  fromEndpoint.getEndpoint,
);
