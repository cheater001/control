...
export const routerFeatureState = createFeatureSelector<RouterReducerState<RouterStateUrl>>(ROUTER_FEATURE_KEY);
...
export function getRouterParam(paramName: string) {
  return createSelector(getRouterParams, params => params && params[ paramName ]);
}
